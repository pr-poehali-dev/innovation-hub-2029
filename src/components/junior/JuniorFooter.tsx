export function JuniorFooter() {
  return (
    <footer className="py-12 border-t-2 border-[#3DBA6E]" style={{ background: "#fafafa" }}>
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              {[
                ...
                <li key={item.href}>
                  <a href={item.href} className="text-gray-500 hover:text-[#7B5EA7] font-semibold transition-colors">
                    {item.label}
                  </a>
                </li>
              ))}
          ...
          <div>
            ...
            <div className="space-y-2 text-gray-500 text-sm font-semibold">
              ...
              <div>
                <a href="tel:+79788685437" className="text-[#7B5EA7] hover:underline">
                  📞 +7 (978) 868-54-37
                </a>
              </div>
            </div>
        ...
        <div className="border-t border-gray-200 pt-6 flex flex-col md:flex-row justify-between items-center gap-3">
          ...
          <div className="flex gap-4 text-sm text-gray-400">
            <a href="#" className="hover:text-[#7B5EA7] transition-colors">Политика конфиденциальности</a>
          </div>
        </div>
      </div>
    </footer>
